...
class PipeBlock(override val material: MaterialBase, val speed: Int) : TransmitterBlock(Properties.of()),
    MaterialContainer {
    override fun newBlockEntity(pos: BlockPos, state: BlockState) = PipeBlockEntity(pos, state)
}
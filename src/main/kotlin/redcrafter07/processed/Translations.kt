...
object Translations {
    ...
    inline fun materialPlate(material: MaterialBase) = t("processed.item.material_plate", material)
    inline fun materialRod(material: MaterialBase) = t("processed.item.material_rod", material)
    inline fun materialScrew(material: MaterialBase) = t("processed.item.material_screw", material)
    inline fun materialWiring(material: MaterialBase) = t("processed.item.material_wiring", material)

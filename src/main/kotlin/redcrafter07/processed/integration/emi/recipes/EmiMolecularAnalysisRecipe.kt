...
class EmiMolecularAnalysisRecipe(recipe: RecipeHolder<MolecularAnalysisRecipe>) : EmiRecipe {
    val recipeInput: EmiIngredient = EmiStack.of(recipe.value.inputStack)
    ...
    override fun getCategory() = Categories.MOLECULAR_ANALYSIS
    ...
    override fun getDisplayWidth() = 110
    ...
    override fun addWidgets(widgets: WidgetHolder) {
        ...
        val energyBar = widgets.add(EnergyWidget(98, 5, baseTier.scalePower(baseEnergy) * timeTicks))
        val computationBar = widgets.add(ComputationWidget(86, 5, ProcessedComputation.computationForTier(baseTier)))

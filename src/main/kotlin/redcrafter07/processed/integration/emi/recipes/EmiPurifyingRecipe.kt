...
class EmiPurifyingRecipe(recipe: RecipeHolder<PurifyingRecipe>) : EmiRecipe {
    ...
    override fun getCategory() = Categories.PURIFYING
    ...
    override fun addWidgets(widgets: WidgetHolder) {
        ...
        val progress = EmiUtil.addProgress(ProgressBars.PURIFIER, widgets, 39, 21, timeTicks)
        val energyBar =
            widgets.add(EnergyWidget(128, 5, baseTier.scalePower(baseEnergy) * timeTicks))

...
import redcrafter07.processed.gui.CrusherMenu
import redcrafter07.processed.recipe.ModRecipes
import redcrafter07.processed.recipe.TieredInput

class CrusherBlockEntity(pos: BlockPos, blockState: BlockState) :
    TieredRecipeBlockEntity(ModTileEntities.CRUSHER.get(), pos, blockState) {
    ...
    override fun getRecipe(): RecipeData? {
        ...
        for (slot in 0..<inputItemHandler.slots) {
            ...
            val recipe = level.recipeManager.getRecipeFor(
                ModRecipes.CRUSHING.type, input, level
    ...
    override fun createMenu(containerId: Int, inventory: Inventory, player: Player): AbstractContainerMenu =
        CrusherMenu(containerId, inventory, this, data)

    override fun getDisplayName(): Component = Translations.crusherName(tier)
}
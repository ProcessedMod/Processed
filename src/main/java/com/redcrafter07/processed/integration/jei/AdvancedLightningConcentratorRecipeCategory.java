...
public class AdvancedLightningConcentratorRecipeCategory implements IRecipeCategory<AdvancedLightningConcentratorRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(Processed.MOD_ID, "advanced_lightning");
    ...
    public AdvancedLightningConcentratorRecipeCategory(IGuiHelper helper) {

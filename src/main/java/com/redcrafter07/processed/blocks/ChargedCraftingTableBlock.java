...
import com.redcrafter07.processed.container.ChargedCraftingTableContainer;
import com.redcrafter07.processed.container.CraftingStationContainer;
import com.redcrafter07.processed.tileentity.ChargedCraftingTableTile;
...
public class ChargedCraftingTableBlock extends Block {
    public ChargedCraftingTableBlock(Properties properties) {
        super(properties);
    }
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return ModTileEntities.CHARGED_CRAFTING_TABLE_TILE.get().create();
    }
    ...
    public ActionResultType onBlockActivated(BlockState blockState, World world, BlockPos blockPos, PlayerEntity playerEntity, Hand hand, BlockRayTraceResult blockRayTraceResult) {
        if (!world.isRemote()) {
            ...
            if (tileEntity instanceof ChargedCraftingTableTile) {
    ...
    private INamedContainerProvider createContainerProvider(World world, BlockPos blockPos) {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.processed.charged_crafting_table");
            }

            @Nullable
            @Override
            public Container createMenu(int p_createMenu_1_, PlayerInventory inv, PlayerEntity player) {
                return new ChargedCraftingTableContainer(p_createMenu_1_, world, blockPos, inv, player);
            }
        };
    }

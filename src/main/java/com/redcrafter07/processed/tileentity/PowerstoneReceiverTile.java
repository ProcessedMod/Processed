...
public class PowerstoneReceiverTile extends TileEntity implements ITickableTileEntity {
    public static final BooleanProperty PLUGGED = PowerstoneReceiverBlock.PLUGGED;

    public PowerstoneReceiverTile(TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);
    }

    public PowerstoneReceiverTile() {
        this(ModTileEntities.POWERSTONE_RECEIVER_TILE.get());
    }
    ...
    public void tick() {
        ...
        updateBlockState(pos, world, getBlockState());
    }
}

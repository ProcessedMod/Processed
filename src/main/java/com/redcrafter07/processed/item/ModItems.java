...
public class ModItems {
    ...
    public static final RegistryObject<Item> PROCESSOR_SWORD = ITEMS.register("processor_sword", () -> new ProcessorSwordItem(ModItemTier.PROCESSOR, 2, 3f, new Item.Properties().group(ModItemGroup.TOOLS_GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> MANIPULATION_PROCESSOR = ITEMS.register("manipulation_processor", () -> new ManipulationProcessor(new Item.Properties().group(ModItemGroup.MAIN_GROUP)));

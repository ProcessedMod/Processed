...
public class AdvancedLightningConcentratorContainer extends Container {
    private final TileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;

    public AdvancedLightningConcentratorContainer(int containerId, World world, BlockPos blockPos, PlayerInventory inv, PlayerEntity playerEntity) {
        super(ModContainers.ADVANCED_LIGHTNING_CONCENTRATOR_CONTAINER.get(), containerId);
    ...
    public boolean isFull() {
        return getFillState() >= 10000;
    }

    @Override
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerIn, ModBlocks.ADVANCED_LIGHTNING_CONCENTRATOR.get());
    }

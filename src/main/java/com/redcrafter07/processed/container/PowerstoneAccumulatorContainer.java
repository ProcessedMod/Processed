...
public class PowerstoneAccumulatorContainer extends Container {
    private final TileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;

    public PowerstoneAccumulatorContainer(int containerId, World world, BlockPos blockPos, PlayerInventory inv, PlayerEntity playerEntity) {
        super(ModContainers.POWERSTONE_ACCUMULATOR_CONTAINER.get(), containerId);

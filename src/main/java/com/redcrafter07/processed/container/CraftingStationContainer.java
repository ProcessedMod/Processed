...
public class CraftingStationContainer extends Container {
    ...
    public CraftingStationContainer(int containerId, World world, BlockPos blockPos, PlayerInventory inv, PlayerEntity playerEntity) {
        super(ModContainers.CRAFTING_STATION_CONTAINER.get(), containerId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerIn, ModBlocks.CRAFTING_STATION.get());
    }

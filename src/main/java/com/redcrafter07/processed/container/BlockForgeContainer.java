...
public class BlockForgeContainer extends Container {
    ...
    public BlockForgeContainer(int containerId, World world, BlockPos blockPos, PlayerInventory inv, PlayerEntity playerEntity) {
        ...
        if(tileEntity != null)  {
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
                ...
                addSlot(new SlotItemHandler(handler, 1, 100, 36));
            });
        }
    }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerIn, ModBlocks.BLOCK_FORGE.get());
    }

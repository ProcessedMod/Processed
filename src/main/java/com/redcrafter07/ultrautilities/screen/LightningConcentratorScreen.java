...
public class LightningConcentratorScreen extends ContainerScreen<LightningConcentratorContainer> {
    private final ResourceLocation guiLocation = new ResourceLocation(UltraUtilities.MOD_ID, "textures/gui/lightning_concentrator.png");

    public LightningConcentratorScreen(LightningConcentratorContainer container, PlayerInventory inv, ITextComponent textComponent) {

...
import com.redcrafter07.ultrautilities.tileentity.AutoCrafterTile;
    ...
    private INamedContainerProvider createContainerProvider(World world, BlockPos blockPos) {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.ultrautilities.autocrafter");
            }

            @Nullable
            @Override
            public Container createMenu(int p_createMenu_1_, PlayerInventory inv, PlayerEntity player) {
                return new AutoCrafterContainer(p_createMenu_1_, world, blockPos, inv, player);
            }
        };
    };

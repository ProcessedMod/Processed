...
public class AutoCrafterContainer extends Container {
    ...
    public AutoCrafterContainer(int containerId, World world, BlockPos blockPos, PlayerInventory inv, PlayerEntity playerEntity) {
        super(ModContainers.AUTOCRAFTER_CONTAINER.get(), containerId);
